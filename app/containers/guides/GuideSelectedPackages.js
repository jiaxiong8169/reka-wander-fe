    ...
    <View
      ...
      <View>
        <View
          ...
          <Icon style={{marginRight: 5, marginTop: 3}} name="location" size={15}></Icon>
            <Text style={{flex: 7, fontSize: 16}}>Trip Name: </Text>
            <Text style={{fontSize: 16, marginRight: 3,}}>{name}</Text>
          </View>
          <View style={{flexDirection: 'row'}}>
            <Icon style={{marginRight: 5, marginTop: 3}} name="pricetag" size={15}></Icon>
            <Text style={{flex: 7, fontSize: 16}}>Price: </Text>
            <Text style={{fontSize: 16, marginRight: 3}}>{price}</Text>
          </View>
          <View style={{flexDirection: 'row'}}>
          <Icon style={{marginRight: 5, marginTop: 3}} name="time" size={15}></Icon>
